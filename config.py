...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7903452698:AAG3lqIHpu9O0khSq7Ajm2nbKWDjCE2Av8I")
...
DB_NAME = os.environ.get("DATABASE_NAME", "filesharexbot69")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002328461056"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 {first}\n\nI'm a file sharing bot For Premium Corn.")
try:
    ADMINS=[]
